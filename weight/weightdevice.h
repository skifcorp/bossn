...
class WeightDevice : public QObject
{
    Q_OBJECT
public:
    typedef QSharedPointer<WeightDevice> Pointer;


    WeightDevice(const WeightDevice&) = delete;
    virtual ~WeightDevice() {}
...
protected:
    typedef QMap<QString, function<WeightDevice * ()> > FactoryMap;
    WeightDevice() {}
