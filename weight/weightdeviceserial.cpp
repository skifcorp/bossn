#include "weightdeviceserial.h"

bool WeightDeviceSerial::registered = WeightDeviceSerial::registerInFact();


void WeightDeviceSerial::setSettings(const QMap<QString, QVariant>& s)
{
    {
