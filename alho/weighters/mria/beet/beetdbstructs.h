...
namespace alho { namespace mria { namespace data {
...
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_ttn_beet          , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_rez_beet          , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_def_field_beet    , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_bum_beet          , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_cars_beet         , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_kagat_beet        , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_kontr_beet        , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_field_beet        , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_const_beet        , qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_bum_state_log_beet, qx::trait::no_base_class_defined, 1)
QX_REGISTER_HPP_EXPORT_DLL(alho::mria::data::t_action_log_beet   , qx::trait::no_base_class_defined, 1)
