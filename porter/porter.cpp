...
void Porter::addDriver(const QString & n, const QMap<QString, QVariant>& drv_conf, const QList<TagMethod<TagMethodType::Simple>> &tags_methods)
{    
    ...
    for (QList<TagMethod<TagMethodType::Simple>>::const_iterator iter = tags_methods.begin(); iter != tags_methods.end(); ++iter) {
...
{    
    scheduler.addFunction(
            ...
            [this,   driver_index, tag_name] {
                ...
                device->clear();
            }, 500, 450, tag_name + "::" + methods[tag_name].method );
}
